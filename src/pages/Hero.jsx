    ...
    <div
      ...
      <div className='col-span-1 relative rounded-sm row-span-1 max-h-[900px] grid grid-cols-1 grid-rows-5 w-[95%] h-[95%] lg:min-h-[500px] px-5 justify-self-center content-center lg:justify-center justify-items-center py-5'>
        ...
        <p key={2} onMouseEnter={mouseLeave} onClick={(e) => handleParagraphClick(e, 2)} className={`group w-1/2 xs:min-w-100 min-w-[72%] z-1 a6 xs:!text-3xl text-3xl shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 p-10 rounded-xl 
          hover:z-11 hover:w-full  hover:!text-xl hover:xs:!text-2xl hover:sm:!text-3xl hover:md:!text-4xl hover:overflow-visible hover:w-full hover:-ml-2  hover:whitespace-normal hover:min-h-60 bg-gray-400 hover:bg-white
          ...
          ${selectedId === 2 ? 'z-10 !text-2xl xs:!text-2xl sm:!text-3xl md:!text-4xl w-full overflow-visible lg:!-ml-6 whitespace-normal md:!min-h-50 min-h-70 bg-gray-400 bg-white -translate-y-14 !p-2 cursor-pointer border-red-500 border-b-red-500' : 'hover:cursor-pointer'}`}   
          >
        ...
        <p key={3} onMouseEnter={mouseLeave} onClick={(e) => handleParagraphClick(e, 3)} className={`group w-1/2 xs:min-w-100 min-w-[72%] min-w-100 max-h-55 z-2  a6 xs:text-4xl text-3xl shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 p-10 rounded-xl
          hover:z-12 hover:w-full hover:!text-xl hover:xs:!text-2xl hover:sm:!text-3xl hover:md:!text-4xl hover:p-6 hover:w-full hover:overflow-visible hover:whitespace-normal hover:max-h-55 hover:max-h-60 hover:h-60 bg-gray-400 hover:bg-white
          lg:-ml-0 lg:mr-8 lg:-mt-8 ml-0 mr-0 truncate transision-all duration-1000 transform hover:-translate-y-14 
          ${selectedId === 3 ? 'z-10 !p-4  !text-3xl xs:!text-3xl sm:!text-4xl w-full overflow-visible lg:!-ml-6 whitespace-normal min-h-70 bg-gray-400 bg-white !-translate-y-14 cursor-pointer border-red-500 border-b-red-500' : 'hover:cursor-pointer'}`}>
        ...
        hover:z-13 hover:w-full hover:!h-60 hover:xs:!h-60 hover:!text-xl hover:xs:!text-3xl hover:sm:!text-4xl hover:p-6 hover:overflow-visible hover:whitespace-normal hover:h-80 hover:pt-5 bg-gray-400 hover:bg-white
