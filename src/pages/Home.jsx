  ...
  return (
    <main className="" id="homeRef" ref={homeRef}>
      ...
      <Blank
        ...
        speed={-40}
      >
        <div className="w-screen h-screen max-w-screen flex flex-col justify-end items-end p-2 pr-6 z-40 overflow-hidden">
          <ScrollReveal margin="0px 0px -200px 0px" threshold={.5} distance={20} duration={1.5} delay={.5}>
